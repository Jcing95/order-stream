...
#[component]
pub fn OrderStream() -> impl IntoView {
    view! {
        <svg fill="#F5f5f5" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g stroke="currentColor" stroke-width="2" fill="none" fill-rule="evenodd">
                <g stroke-width="2" stroke-linecap="round">
                    <path d="M12 4V7"></path>
                    <path d="M5 14C5 9.58172 8.13401 6 12 6C15.866 6 19 9.58172 19 14"></path>
...
#[component]
pub fn SystemTheme() -> impl IntoView {
    view! {
